...
export function Card(props) {
    return (
        <section className={`relative w-[320px] h-[400px]   cursor-pointer card rounded-lg  `}>
            ...
            <div className={"absolute top-0 left-0  w-full h-full bg-gray-900/90  opacity-0  cardanimation z-20   "}>
                ...
                <p className={`absolute  top-[40%] rotate-90 text-3xl lilita  drop-shadow-md shadow-black tracking-widest uppercase cursor-alias `}></p>
            <div
                className={"absolute top-0 left-0  w-full h-full opacity-0   cardanimation z-20 flex flex-col items-center justify-center cursor-alias  "}>
...
<NavLink to={`/watch/${props.title}/${props.id}` }>
